...
class Scheduler(SchedulerInterface):
    ...
    def update_from_output(
        ...
        spec_step_metrics = model_runner_output.spec_step_metrics
        ...
        for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
            ...
            if scheduled_spec_token_ids:
                ...
                spec_decoding_stats = self.make_spec_decoding_stats(
                    ...
                    num_reverify=1 if num_rejected > 0 else 0,
                    num_early_stops=1 if num_rejected > 0 else 0,
                    num_verify_tokens=len(generated_token_ids),
                )
        ...
        if spec_decoding_stats is not None and spec_step_metrics:
            spec_decoding_stats.observe_timing(
                draft_time_ms=spec_step_metrics.get("draft_time_ms"),
                verify_time_ms=spec_step_metrics.get("verify_time_ms"),
            )
