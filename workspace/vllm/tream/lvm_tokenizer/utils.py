...
import torch
try:
    import torch_tensorrt  # type: ignore  # NEEDED FOR VQGAN acceleration
except Exception as e:
    # Catch broad exceptions (e.g., OSError from binary mismatch) and fall back.
    print(f"[VQGAN] torch_tensorrt unavailable: {type(e).__name__}: {e}")
    torch_tensorrt = None
...
RAW_VQGAN_PATH = "./lvm_tokenizer/ckpt/laion"
COMPILED_VQGAN_PATH = "./lvm_tokenizer/ckpt/vqgan_encode_trt.pt"
ENCODING_SIZE = 256
