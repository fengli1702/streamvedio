...
class LocalReroutePolicy:
    ...
    def select_next(
        ...
        *,
        ...
        prefer_descending = latency_pressure or accept_pressure
        if str(mode).upper() == "ADAPT" and not bool(allow_local_uphill):
        ...
        if prefer_descending:
            ...
            if descending:
                ...
                if not bool(allow_local_uphill):
        ...
        return Decision(
            ...
            meta={
                ...
                "reroute_allow_local_uphill": 1.0 if bool(allow_local_uphill) else 0.0,
            },
        )
