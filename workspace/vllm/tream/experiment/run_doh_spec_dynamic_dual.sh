...
SCRIPT_A="${SCRIPT_A:-${SCRIPT_DIR}/exp_doh_spec_dynamic_grid_a.sh}"
SCRIPT_B="${SCRIPT_B:-${SCRIPT_DIR}/exp_doh_spec_dynamic_grid_b.sh}"
...
RAY_TEMP_DIR_A="${RAY_TEMP_DIR_A:-/tmp/ray_tream_dyn_a}"
RAY_TEMP_DIR_B="${RAY_TEMP_DIR_B:-/tmp/ray_tream_dyn_b}"

RUNNER="${RUNNER:-python}"
MAX_FRAMES="${MAX_FRAMES:-4000}"

LOG_A="${LOG_A:-${REPO_ROOT}/inference_logs/doh_spec_dynamic_a.log}"
LOG_B="${LOG_B:-${REPO_ROOT}/inference_logs/doh_spec_dynamic_b.log}"
