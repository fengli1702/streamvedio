...
if [[ "${RUN_MODE}" == "dynamic" ]]; then
  MODE_TAG="dyn_wb${SHIFT_COLD_WHITELIST_PROBE}b${SHIFT_COLD_WHITELIST_BUDGET}j${SHIFT_COLD_WHITELIST_MAX_SWITCH}_jsd${SHIFT_SHOCK_USE_JSD_ONLY}_cw${SHIFT_COLD_START_WINDOWS}"
else
