...
run_one() {
  ...
  if PYTHONPATH="/workspace/vllm:${PYTHONPATH:-}" \
...
queue_a() {
  ...
  run_one "A" "2" "${RAY_ADDR_A}" 1 2 || failures=$((failures + 1))
  run_one "A" "3" "${RAY_ADDR_A}" 2 2 || failures=$((failures + 1))
  run_one "A" "4" "${RAY_ADDR_A}" 2 4 || failures=$((failures + 1))
  run_one "A" "5" "${RAY_ADDR_A}" 3 2 || failures=$((failures + 1))
  run_one "A" "6" "${RAY_ADDR_A}" 3 4 || failures=$((failures + 1))
  run_one "A" "7" "${RAY_ADDR_A}" 4 2 || failures=$((failures + 1))
  run_one "A" "8" "${RAY_ADDR_A}" 4 4 || failures=$((failures + 1))
  return "${failures}"
}
...
queue_b() {
  ...
  run_one "B" "3" "${RAY_ADDR_B}" 3 8 || failures=$((failures + 1))
  run_one "B" "4" "${RAY_ADDR_B}" 4 8 || failures=$((failures + 1))
  run_one "B" "5" "${RAY_ADDR_B}" 4 6 || failures=$((failures + 1))
  run_one "B" "6" "${RAY_ADDR_B}" 6 6 || failures=$((failures + 1))
  run_one "B" "7" "${RAY_ADDR_B}" 6 8 || failures=$((failures + 1))
  run_one "B" "8" "${RAY_ADDR_B}" 8 8 || failures=$((failures + 1))
  return "${failures}"
}
...
start_ray_head "A" "${GPU_A}" 28121 52365 60121 57121 8265 "${RAY_TEMP_A}"
start_ray_head "B" "${GPU_B}" 28122 52366 60122 57122 8266 "${RAY_TEMP_B}"
