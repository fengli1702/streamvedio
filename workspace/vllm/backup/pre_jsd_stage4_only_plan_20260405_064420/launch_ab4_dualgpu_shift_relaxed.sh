...
run_one() {
  ...
  if env -u RAY_ADDRESS -u RAY_PORT -u RAY_GCS_SERVER_PORT \
      ...
      TREAM_SHIFT_COLD_RELAX_SAFETY="${TREAM_SHIFT_COLD_RELAX_SAFETY:-1}" \
      TREAM_SHIFT_MIN_COUNT_FOR_TRUST="${TREAM_SHIFT_MIN_COUNT_FOR_TRUST:-1}" \
      TREAM_SHIFT_ADAPT_PROBE_WINDOWS="${TREAM_SHIFT_ADAPT_PROBE_WINDOWS:-8}" \
      TREAM_SHIFT_COLD_WHITELIST_BUDGET="${TREAM_SHIFT_COLD_WHITELIST_BUDGET:-12}" \
